...
def get_pruned_copy(genome, genome_config):
        used_node_genes, used_connection_genes = get_pruned_genes(genome, genome.nodes, genome.connections,
...
def get_pruned_genes(genome, node_genes, connection_genes, input_keys, output_keys):

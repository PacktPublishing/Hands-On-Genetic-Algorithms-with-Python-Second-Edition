...
QUEEN_THUMBNAIL_PATH = os.path.join(os.path.realpath(os.path.join(os.getcwd(), os.path.dirname(__file__))), 'queen_thumbnail.png')
...
class NQueensProblem:
    ...
    def plotBoard(self, positions):
        ...
        queenThumbnail = plt.imread(QUEEN_THUMBNAIL_PATH)
